...
author: "Tiffany Timbers & Jordan Bourak & Yicheng Huang"
format: 
  html:
    number-figures: true
    number-tables: true
...
Additionally, note that in @tbl-horses_sd_table we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot.
